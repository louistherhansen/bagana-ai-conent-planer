  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 sm:p-5">
        <h3 className="font-semibold text-slate-800 mb-4">History Market Trend Insights (by Brand Name)</h3>
        <div className="mb-4">
        ...
        {!loading && !error && history.length === 0 && (
          <div className="py-8 text-center text-slate-500 text-sm">
            Belum ada hasil trend research. Generate dari Chat (crew akan menyimpan otomatis).
          </div>
        )}
        {!loading && !error && history.length > 0 && (
      ...
      {selected && (
        <div className="rounded-xl border border-slate-200 bg-white p-4 sm:p-6 space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="font-semibold text-slate-800">Market Trend Insights — {selected.brandName}</h3>
            <button
              type="button"
      ...
      {!selected && history.length === 0 && !loading && (
        <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50/50 p-8 sm:p-12 text-center">
          ...
          <h3 className="font-semibold text-slate-800 mb-1">Belum ada trend insights</h3>
